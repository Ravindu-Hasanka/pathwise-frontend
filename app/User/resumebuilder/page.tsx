  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Resume Builder & Optimizer</h1>
          <p className="text-gray-300 text-lg">
            Create a professional resume from scratch or enhance your existing one with AI
          </p>
        </div>

        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-slate-800/50 border border-white/10">
            <TabsTrigger value="builder" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-white">
              <FileText className="h-4 w-4 mr-2" />
              Build Resume
            </TabsTrigger>
            <TabsTrigger value="optimizer" className="data-[state=active]:bg-purple-500/20 data-[state=active]:text-white">
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      {resumeData.experiences.map((exp) => (
                        <Card key={exp.id} className="bg-slate-700/30 border-white/10">
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      {resumeData.education.map((edu) => (
                        <Card key={edu.id} className="bg-slate-700/30 border-white/10">
                          <CardContent className="p-6">
                            <div className="flex justify-end">
                              <Button
                                variant="ghost"
          ...
          <TabsContent value="optimizer">
            <Card className="bg-slate-800/50 border-white/10">
              <CardHeader>
                <CardTitle className="text-white">AI Resume Optimizer</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-8">
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-300 mb-6 max-w-lg mx-auto">
                      Our AI will analyze your resume and provide optimization suggestions to help you stand out
                    </p>
                  ...
                  {resumeFile && (
                    <div className="space-y-6">
                      <div className="bg-slate-700/30 rounded-lg p-6 border border-white/10">
                        <h4 className="text-white font-medium mb-4">Optimization Preferences</h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            <Label className="text-white">Target Job Title</Label>
                            <Input
