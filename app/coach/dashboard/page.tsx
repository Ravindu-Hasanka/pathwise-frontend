        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <Card className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 border-orange-500/30">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-orange-300 text-sm font-medium">Upcoming Sessions</p>
                ...
                <div className="bg-slate-800/50 border-white/10 py-8 rounded-xl mt-8">
                    {/* Common Header for both columns */}
                            ...
                            <div className="w-full max-w-md mx-auto bg-slate-700/30 rounded-lg p-4 border border-white/10">
                                ...
                                <ul className="divide-y divide-slate-700">
                                    <li className="py-2 flex justify-between items-center">
                                        <span className="text-white">June 24, 10:00 AM – John Doe</span>
                                        <span className="text-gray-400 text-sm">Resume Review</span>
                                    </li>
                                    <li className="py-2 flex justify-between items-center">
                                        <span className="text-white">June 25, 2:00 PM – Jane Smith</span>
                                        <span className="text-gray-400 text-sm">Mock Interview</span>
                                    </li>
                                </ul>
                            </div>
                            <div className="w-full max-w-md mx-auto">
                                ...
                                <Card className="bg-slate-700 rounded-lg border-none">
                                    <CardContent className="p-4 text-gray-200 text-center">
                                        "Great session! Helped me clarify my next steps." – Jane Smith
                                    </CardContent>
                                </Card>
                            </div>
                        </div>
